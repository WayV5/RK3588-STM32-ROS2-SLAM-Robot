...
a55_khz=$(cat /sys/devices/system/cpu/cpu0/cpufreq/scaling_cur_freq)
a76_khz=$(cat /sys/devices/system/cpu/cpu4/cpufreq/scaling_cur_freq)
echo "  Governor: $(cat /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor)"
echo "  A55 freq: $((a55_khz / 1000)) MHz"
echo "  A76 freq: $((a76_khz / 1000)) MHz"
...
if [ -d "$NPU_DEVFREQ" ]; then
    ...
    npu_hz=$(cat $NPU_DEVFREQ/cur_freq)
    echo "  Governor: $(cat $NPU_DEVFREQ/governor)"
    echo "  Frequency: $((npu_hz / 1000000)) MHz"
else
