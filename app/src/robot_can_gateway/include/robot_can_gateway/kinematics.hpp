...
constexpr double WHEEL_RADIUS   = 0.0318;	// effective radius (m), 标称65mm→实测有效~63.6mm (2026-06-14 直线标定)
...
constexpr double WHEEL_BALANCE  = 0.003;	// tuned: 0.007过矫(偏右-0.04)→调回0.003 (2026-06-14)
